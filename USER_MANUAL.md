...
| Calculated + AI-judged | The Health report as a whole; What if…; Motifs, symbols & themes; Discover themes (AI); the Character arc simulator; the Evidence check; Characters > Deeper check (AI). |
